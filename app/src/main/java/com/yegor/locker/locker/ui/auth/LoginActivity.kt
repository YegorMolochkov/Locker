...
/**
 * A login screen that offers login via car sn/password.
 */
class LoginActivity : AppCompatActivity(), AuthView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initPresenter()
        submit.setOnClickListener { mPresenter.tryToLogin(Credentials(serialNumber.text.toString(), password.text.toString())) }
    }
